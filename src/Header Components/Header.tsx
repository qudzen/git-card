                ...
                <div className='flex justify-between items-center px-8 py-4 max-w-7xl mx-auto'>
                    ...
                    <div className='flex items-center gap-4'>
                        <div className='relative '>
                            <input
                                className='bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-white border-gray-200 dark:border-gray-600 border-2 rounded-full px-6 py-3 w-80 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500 transition-all'
                                type="search"
