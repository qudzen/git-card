        ...
        {results !== null ?
            <>
                <div className='grid grid-rows-[1fr_1fr]'>
                    <div className='border-2 border-amber-900 flex items-center gap-4 relative'>
                    ...
                    <div className='font-bold mr-9 line-clamp-7'>
                        {results.bio}
                    </div>
                    </div>
                ...
                <div className='border-2 border-b-blue-400'>
                    {reposUser !== null && reposUser.map(repo => (
